...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '青松', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://fasterai.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI, 人工智能, AI快车道, AI快速入门, NLP快速入门, 大模型面试, NLP 面试, FasterAI', // 网站关键词 英文逗号隔开
  ...
  // 自定义菜单
  CUSTOM_MENU: process.env.N˚EXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu类型的菜单，替代了3.12版本前的Page类型
